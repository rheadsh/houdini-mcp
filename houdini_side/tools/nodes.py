...
def _node_info(node):
    ...
    return {
        ...
        "display_flag": node.isDisplayFlagSet() if hasattr(node, 'isDisplayFlagSet') else False,
        "render_flag": node.isRenderFlagSet() if hasattr(node, 'isRenderFlagSet') else False,
        "color": color_rgb,
        "position": position,
